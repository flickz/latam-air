...
if ( typeof tldc.funnelSegments['1289'] == 'undefined' ) {
  tldc.funnelSegments['1289'] = [];
  var n=0;
	tldc.funnelSegments['1289'][n++] = { 'seg':'7142923', 	'step':1, 'ievs':'7142920', 'conv':'788961' };
	tldc.funnelSegments['1289'][n++] = { 'seg':'7142924', 	'step':2, 'ievs':'7142921', 'conv':'788962' };
	tldc.funnelSegments['1289'][n++] = { 'seg':'7142929', 	'step':3, 'ievs':'7142922', 'conv':'788963' };
	tldc.funnelSegments['1289'][n++] = { 'seg':'7209201', 	'step':4, 'ievs':'7209075', 'conv':'0' };
	tldc.funnelSegments['1289'][n++] = { 'seg':'7209220', 	'step':5, 'ievs':'7209081', 'conv':'791274' };
	tldc.funnelSegments['1289'][n++] = { 'seg':'7209238', 	'step':6, 'ievs':'7209085', 'conv':'791275' };
	tldc.funnelSegments['1289'][n++] = { 'seg':'7209256', 	'step':7, 'ievs':'7209090', 'conv':'791276' };
...
function insertInDom(a){var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(a,d)}function firePixel(a,d){var e=document.createElement("img"),b;e.style.position="absolute";e.style.height=0;e.style.width=0;b="http:"===document.location.protocol?"http://ib.adnxs.com/":"https://secure.adnxs.com/";e.src="undefined"==typeof d?b+"seg?add="+a+"&t=2":b+"seg?add="+a+":"+d+"&t=2";insertInDom(e)}function contains(a,d){for(var e=a.length;e--;)if(a[e]===d)return!0;return!1}
...
for (var i = 0; i < scriptTags.length; i++) {
  ...
  if (undefined !== ssrc && null !== ssrc && ssrc.indexOf('fseg') !== -1 && ssrc.indexOf('1289.js') !== -1) {  	
    ...
    //console.log('tlfseg:'+JSON.stringify(tldc.tlfseg));
    	if ( typeof tldc.tlfseg[qs.add] === 'undefined' ) {	    		  		
    		if ( processFunnelSegVal(qs.add,qs.val,'1289',tldc.funnelSegments['1289']) ) tldc.tlfseg[qs.add] = 1;  
    	}
    }
  }
}
