...
if ( typeof tldc.advid === 'undefined' ) tldc.advid = '1405984';
function error(msg) {
  var version = "3.0.1b";
  var now = new Date();
  var dUrl = '';
...
tldc.cvPx['788962'] = {};
tldc.cvPx['788962'].a = 788962;
tldc.cvPx['788962'].l = [3580496,3580752,3613027,3660893,3660894];
tldc.cvPx['788962'].i = 7; 
tldc.cvPx['788962'].c = 30; 
tldc.cvPx['788962'].t = 'h';
tldc.cvPx['788962'].m = 'null';
tldc.cvPx['788962'].vi = 0;
tldc.cvPx['788962'].vc = 0;
tldc.cvPx['788962'].hf = 0;
tldc.cvPx['788962'].x = tldc.xtra;
...
var TradeLabConvTracker = function (cdata) {
  ...
  if ( typeof tldc.tl_getAnalyticsData === 'undefined' && typeof tl_getAnalyticsData === 'function' ) tldc.tl_getAnalyticsData = tl_getAnalyticsData;   
    ...
    if ( !tldc.tl_check4xconv(788962) ) {
        if ( typeof tldc.tl_addXconv === 'function' ) tldc.tl_addXconv(788962);
      }
      else xval = 0;
  }
  if ( typeof document.cookie != 'undefined' ) {
    ...
    a.style.height = 0;
    a.style.width = 0;    
    if ( document.location.protocol == 'http:' ) asrc="http://ib.adnxs.com/px?id=788962";
    else asrc="https://secure.adnxs.com/px?id=788962";
...
if ( tldc.cvPx['788962'].hf == 0 ) {  
  if ( TradeLabConvTracker(stringify(tldc.cvPx['788962'])) ) tldc.cvPx['788962'].hf = 1;
}
