...
(function($) {
	...
	$.fn.extend({
		//Helper Function for customCaret positioning
		customCaret: function(begin, end) {
		...
		mask: function(mask, settings) {
			...
			return this.trigger("unmask").each(function() {
				...
				function shiftL(begin,end) {
					...
					writeBuffer();
					input.customCaret(Math.max(firstNonMaskPos, begin));
				};
				...
				if (!input.attr("readonly"))
					...
					.bind("focus.mask", function() {
						...
						var pos = checkVal();
						writeBuffer();
						var movecustomCaret=function(){
							if (pos == mask.length)
								input.customCaret(0, pos);
							else
								input.customCaret(pos);
						};
						($.browser.msie ? movecustomCaret:function(){setTimeout(movecustomCaret,0)})();
					})
					.bind("blur.mask", blurEvent)
					.bind("keydown.mask", keydownEvent)
					.bind("keypress.mask", keypressEvent)
					.bind(pasteEventName, function() {
						setTimeout(function() { input.customCaret(checkVal(true)); }, 0);
					});
